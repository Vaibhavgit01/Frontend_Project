      ...
      <div className="relative group">
        ...
        {showDropdown && (
          <ul className="absolute top-full mt-2 bg-black text-white w-40 rounded shadow-md z-50">
            <NavLink to="/onebhk" className="block px-4 py-2 hover:bg-gray-700">1 Bhk</NavLink>
            <NavLink to="/Twobhk" className="block px-4 py-2 hover:bg-gray-700">2 Bhk</NavLink>
            <NavLink to="/Threebhk" className="block px-4 py-2 hover:bg-gray-700">3 Bhk</NavLink>
          </ul>
        )}
      </div>
  ...
  {isMenu && (
    <div className="md:hidden flex flex-col gap-2 py-4">
      ...
      <div className="flex items-center gap-2 px-2 pt-2">
        <BsSearch className="text-white text-2xl" />
        <button className="text-lg font-semibold bg-white px-4 py-1 rounded-xl text-black hover:bg-gray-200">
          Login
        </button>
      </div>
    </div>
